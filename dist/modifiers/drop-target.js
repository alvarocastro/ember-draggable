 ...
 * @return {Object}
 */
const prepareDataForCallback = function (event) {
  const source = {
 ...
 * @return {Number}
 */
const getNestedDepth = function (event) {
 ...
 */
var dropTarget = modifier(function dropTarget(element, positional, {
  data,
  group,
  accepts = [],
...
export { CLASS, DIRECTION, DIRECTION_EDGES, dropTarget as default, getNestedDepth, prepareDataForCallback };
